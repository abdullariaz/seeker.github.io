    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> Patia, Bhubaneswar, Odisha, India 751024</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">0674 2725113</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:info@kiit.ac.in">kiit@kiit.ac.in</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">kiit.ac.in</a></p>
          </div>
        </div>
